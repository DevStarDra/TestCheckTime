...
{
    public partial class SalaryReportTotal
    {
        ...
        public string AllowanceTotal { get; set; } = "";
        public string TotalAllowanceNo { get; set; } = "";
        public string TotalAllowanceValue { get; set; } = "";
        public string LessHourTotal { get; set; } = "";
        public string LessHourTotalDays { get; set; } = "";
        public long? Flag { get; set; } = 0;
        public string TotalOt1 { get; set; } = "";
        ...
        public string TotalActualDays { get; set; } = "";
